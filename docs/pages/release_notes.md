...
* New Canny edge detector function,
  `af::canny()`. <sup>[1](https://github.com/arrayfire/arrayfire/pull/1743)</sup>
* New OpenCL BLAS backend,
...
* Performance improvements in
  `af::reorder()`. <sup>[1](https://github.com/arrayfire/arrayfire/pull/1766)</sup>
* Cache backend symbols for the Unified
  backend. <sup>[1](https://github.com/arrayfire/arrayfire/pull/1770)</sup>

Examples
--------

* New genetic algorithm
  example. <sup>[1](https://github.com/arrayfire/arrayfire/pull/1695)</sup>

Bug Fixes
---------

* Argument checks in `af_create_sparse_array` avoids inputs of type
...
* Fixing correctness of `af_pow` for complex numbers by using Cartesian
  form. <sup>[1](https://github.com/arrayfire/arrayfire/pull/1765)</sup>
* Corrected `af::select()` with indexing in CUDA and OpenCL
...
* Fixes for Windows for CUDA after C++11
  introduction. <sup>[1](https://github.com/arrayfire/arrayfire/pull/1723)</sup>
* Fixed minor warnings in
  `medfilt`. <sup>[1](https://github.com/arrayfire/arrayfire/pull/1786)</sup>
* Fixed build target dependencies in the OpenCL
  backend. <sup>[1](https://github.com/arrayfire/arrayfire/pull/1792)</sup>
* Fixed sparse compile
  errors. <sup>[1](https://github.com/arrayfire/arrayfire/pull/1791)</sup>

Installer fixes
---------------

* Fixed broken Forge symlinks affecting OSX
  installer. <sup>[1](https://github.com/arrayfire/arrayfire/pull/1707)</sup>

Cleanup
-------

* Removed `CL_TO_AF_ERROR`
  macro. <sup>[1](https://github.com/arrayfire/arrayfire/pull/1690)</sup>
* Remove superfluous macros from approx
  tests. <sup>[1](https://github.com/arrayfire/arrayfire/pull/1795)</sup>
* Removed dead preprocessor
  directives. <sup>[1](https://github.com/arrayfire/arrayfire/pull/1697)</sup>
...
* Removed CUDA 6.5
  support. <sup>[1](https://github.com/arrayfire/arrayfire/pull/1687)</sup>
* Enabled C++11 for the CUDA backend; removed unnecessary Boost
  dependency. <sup>[1](https://github.com/arrayfire/arrayfire/pull/1691)</sup>
* Updated Google Test submodule
  URL. <sup>[1](https://github.com/arrayfire/arrayfire/pull/1788)</sup>
* Increase `svd_dense` test thresholds on
  macOS. <sup>[1](https://github.com/arrayfire/arrayfire/pull/1796)</sup>

Known issues
------------

* Windows not yet thread-safe.
* The `canny_opencl` test fails on CUDA devices on macOS.
* Non-free sift and gloh test compiled with VS2015 fail on Windows.
* The `cholesky_dense_opencl` tests currently failing on OSX with AMD
  hardware.
