...
typedef enum {
    ...
    AF_RANDOM_MERSENNE_GP11213 = 300,
    AF_RANDOM_PHILOX = AF_RANDOM_PHILOX_4X32_10,
    AF_RANDOM_THREEFRY = AF_RANDOM_THREEFRY_2X32_16,
    AF_RANDOM_MERSENNE = AF_RANDOM_MERSENNE_GP11213,
    AF_RANDOM_DEFAULT = AF_RANDOM_PHILOX
} af_random_type;
#endif
