...
*/
AFAPI array transform(const array& in, const array& transform, const dim_t odim0, const dim_t odim1, const interpType method=AF_INTERP_NEAREST, const bool inverse=true);
...
*/
AFAPI array translate(const array& in, const float trans0, const float trans1, const dim_t odim0, const dim_t odim1, const interpType method=AF_INTERP_NEAREST);
...
*/
AFAPI array scale(const array& in, const float scale0, const float scale1, const dim_t odim0, const dim_t odim1, const interpType method=AF_INTERP_NEAREST);
...
*/
AFAPI array skew(const array& in, const float skew0, const float skew1, const dim_t odim0, const dim_t odim1, const bool inverse=true, const interpType method=AF_INTERP_NEAREST);
