...
AFAPI af_err af_memory_event_pair_set_event(af_memory_event_pair pairHandle, af_event event);

AFAPI af_err af_memory_event_pair_get_ptr(af_memory_event_pair pair, void** ptr);

AFAPI af_err af_memory_event_pair_get_event(
    af_memory_event_pair pair,
    af_event* event);
