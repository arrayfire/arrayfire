...
namespace af
{
    ...
    class AFAPI randomEngine {
        ...
        public:
            explicit
            randomEngine(randomType typeIn = AF_RANDOM_PHILOX, unsigned long long seedIn = 0);
            ~randomEngine();
...
extern "C" {
    ...
    */
    AFAPI af_err af_create_random_engine(af_random_engine *engine, af_random_type rtype, unsigned long long seed);
