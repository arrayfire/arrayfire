...
// template<af_op_t op>
// static af_err af_arith_sparse(af_array *out, const af_array lhs, const
// af_array rhs)
//{
//    try {
...
af_err af_add(af_array *out, const af_array lhs, const af_array rhs,
    ...
    if (linfo.isSparse() && rinfo.isSparse()) {
        return AF_ERR_NOT_SUPPORTED;  // af_arith_sparse<af_add_t>(out, lhs,
                                      // rhs);
    } else if (linfo.isSparse() && !rinfo.isSparse()) {
        return af_arith_sparse_dense<af_add_t>(out, lhs, rhs);
    } else if (!linfo.isSparse() && rinfo.isSparse()) {
        return af_arith_sparse_dense<af_add_t>(out, rhs, lhs,
...
af_err af_mul(af_array *out, const af_array lhs, const af_array rhs,
    ...
    if (linfo.isSparse() && rinfo.isSparse()) {
        return AF_ERR_NOT_SUPPORTED;  // af_arith_sparse<af_mul_t>(out, lhs,
                                      // rhs);
    } else if (linfo.isSparse() && !rinfo.isSparse()) {
...
af_err af_sub(af_array *out, const af_array lhs, const af_array rhs,
    ...
    if (linfo.isSparse() && rinfo.isSparse()) {
        return AF_ERR_NOT_SUPPORTED;  // af_arith_sparse<af_sub_t>(out, lhs,
                                      // rhs);
    } else if (linfo.isSparse() && !rinfo.isSparse()) {
...
af_err af_div(af_array *out, const af_array lhs, const af_array rhs,
    ...
    if (linfo.isSparse() && rinfo.isSparse()) {
        return AF_ERR_NOT_SUPPORTED;  // af_arith_sparse<af_div_t>(out, lhs,
                                      // rhs);
    } else if (linfo.isSparse() && !rinfo.isSparse()) {
