...
struct Interp1<InT, LocT, 3> {
    void operator()(Param<InT> &out, int ooff, CParam<InT> &in, int ioff,
        ...
        bool cond[4] = {grid_x - 1 >= 0, true, grid_x + 1 < idims[0],
                        grid_x + 2 < idims[0]};
...
struct Interp2<InT, LocT, 3> {
    void operator()(Param<InT> &out, int ooff, CParam<InT> &in, int ioff,
        ...
        bool condX[4] = {grid_x - 1 >= 0, true, grid_x + 1 < idims[0],
                         grid_x + 2 < idims[0]};
        bool condY[4] = {grid_y - 1 >= 0, true, grid_y + 1 < idims[1],
                         grid_y + 2 < idims[1]};
