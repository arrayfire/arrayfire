...
using mean_dim_func = std::function<void(Array<To>, const dim_t,
                                            const Array<Ti>, const dim_t, const int)>;
...
using mean_weighted_dim_func = std::function<void(Array<T>, const dim_t,
                                            const Array<T>, const dim_t, const Array<Tw>, const dim_t, const int)>;
