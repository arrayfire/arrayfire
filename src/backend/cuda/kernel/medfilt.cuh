...
template<typename T, BorderType pad>
__device__
...
template<typename T, BorderType pad, unsigned w_len, unsigned w_wid>
__global__
...
template<typename T, BorderType pad, unsigned ARR_SIZE>
__global__
