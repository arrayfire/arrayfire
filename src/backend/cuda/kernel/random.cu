...
#define INSTANTIATE(T)                                  \
    template void randu<T>(T *out, size_t elements);    \
    template void randn<T>(T *out, size_t elements);    \
    ...
    template void randu<int>(int *out, size_t elements);
    template void randu<uint>(uint *out, size_t elements);
    template void randu<char>(char *out, size_t elements);
    template void randu<uchar>(uchar *out, size_t elements);
}
}
