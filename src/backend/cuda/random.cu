...
namespace cuda
{
    ...
    template Array<cfloat>  randu<cfloat>  (const af::dim4 &dims, const af::randomType &rtype);
    template Array<cdouble> randu<cdouble> (const af::dim4 &dims, const af::randomType &rtype);
