                 ...
                 const Array<T> &b, const af_mat_prop options)
{
    ...
    CUSOLVER_CHECK(getrs_func<T>()(getcusolverDnHandle(),
                                   CUBLAS_OP_N,
                                   N, NRHS,
                                   A.get(), A.strides()[1],
                                   pivot.get(),
...
Array<T> leastSquares(const Array<T> &a, const Array<T> &b)
{
    ...
    if (M < N) {
        ...
        CUSOLVER_CHECK(geqrf_solve_buf_func<T>()(getcusolverDnHandle(),
                                                 A.dims()[0], A.dims()[1],
                                                 A.get(), A.strides()[1],
                                                 &lwork));
        ...
        CUSOLVER_CHECK(geqrf_solve_func<T>()(getcusolverDnHandle(),
                                             A.dims()[0], A.dims()[1],
                                             A.get(), A.strides()[1],
                                             t.get(),
                                             workspace, lwork,
        ...
        // matmul(Q, Bpad)
        CUSOLVER_CHECK(mqr_solve_func<T>()(getcusolverDnHandle(),
