...
#include "/home/gpryor/new-fftconvolve/io.hpp"
#include "/home/gpryor/new-fftconvolve/msg.hpp"
...
void packDataHelper(Param<convT> packed, Param<T> sig, Param<T> filter,
...
#ifndef DONT_WRITE
    OPEN_W("/home/gpryor/new-fftconvolve/fftconvolve_pack.raw");
    ...
    getQueue().submit([&](auto &h) {
        sycl::accessor d_sig{*sig.data, h, sycl::read_only};
        sycl::accessor d_sig_tmp{sig_tmp_buffer, h, sycl::write_only, sycl::no_init};
        h.parallel_for(sycl::nd_range{global, local},
                       fftconvolve_packCreateKernel<T, typename convT::value_type>(d_sig_tmp, sig_tmp.info, d_sig, sig.info,sig_half_d0, sig_half_d0_odd));
    });
