...
void approx1(Param out, const Param in, const Param xpos, const float offGrid,
    ...
    auto approx1Op =
        KernelFunctor<Buffer, const KParam, const Buffer, const KParam,
                      const Buffer, const KParam, const Ty, const int,
    ...
    approx1Op(EnqueueArgs(getQueue(), global, local), *out.data, out.info,
              *in.data, in.info, *xpos.data, xpos.info, scalar<Ty>(offGrid),
...
void approx2(Param out, const Param in, const Param xpos, const Param ypos,
    ...
    approx2Op(EnqueueArgs(getQueue(), global, local), *out.data, out.info,
              *in.data, in.info, *xpos.data, xpos.info, *ypos.data, ypos.info,
