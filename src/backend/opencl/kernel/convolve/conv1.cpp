...
#define INSTANTIATE(T, accT)  \
    template void conv1<T, accT, true >(const conv_kparam_t& p, Param& out, const Param& sig, const Param& filt); \
    template void conv1<T, accT, false>(const conv_kparam_t& p, Param& out, const Param& sig, const Param& filt); \
