...
void rotate_kernel(__global T *d_out, const KParam out,
                   ...
                   const int blocksXPerImage, const int blocksYPerImage, int method)
{
    ...
    int outoff = out.offset + setId * nimages * out.strides[2] + batch * out.strides[3];
    int inoff = in.offset + setId * nimages * in.strides[2] + batch * in.strides[3];
