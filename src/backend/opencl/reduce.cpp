...
#define INSTANTIATE(Op, Ti, To)                                         \
    ...
    // count
    INSTANTIATE(af_notzero_t, float  , float  )
    INSTANTIATE(af_notzero_t, double , double )
    INSTANTIATE(af_notzero_t, cfloat , cfloat )
    INSTANTIATE(af_notzero_t, cdouble, cdouble)
    INSTANTIATE(af_notzero_t, int    , int    )
    INSTANTIATE(af_notzero_t, uint   , uint   )
    INSTANTIATE(af_notzero_t, char   , int    )
